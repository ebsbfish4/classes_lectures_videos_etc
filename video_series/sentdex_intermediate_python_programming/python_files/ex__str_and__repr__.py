...
# if you create an object, it will show the __repr__ method, while if you print it
# and it has a __str__ method then it will show that.

'''
DEBUG Detailed informaiton, typically of interest only when diagnosing
INFO Confirmation that things are working as expected
WARNING An indication that something unexpected happening
ERROR 
CRITICAL
'''
# You can set the level to whatever, and then everything of that level or above will be reported
